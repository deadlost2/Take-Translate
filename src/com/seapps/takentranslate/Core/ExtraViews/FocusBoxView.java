package com.seapps.takentranslate.Core.ExtraViews;
...
import com.seapps.takentranslate.R;
...
public class FocusBoxView extends View {
						...
						try {
							...
							if (lastX >= 0) {
								if (((currentX >= rect.left - BIG_BUFFER && currentX <= rect.left + BIG_BUFFER)
									...
									// BUFFER pixels of
									// left side, and between top and bottom
									// side limits
									...
									// BUFFER pixels of
									// right side, and between top and bottom
									// side limits
									...
									// BUFFER pixels of
									// top side, and between left and right side
									// limits
	...
	public void onDraw(Canvas canvas) {
		...
		canvas.drawCircle(frame.left - rad, frame.top - rad, 3 * rad, paint);
		canvas.drawCircle(frame.right + rad, frame.top - rad, 3 * rad, paint);
		canvas.drawCircle(frame.left - rad, frame.bottom + rad, 3 * rad, paint);
		canvas.drawCircle(frame.right + rad, frame.bottom + rad, 3 * rad, paint);
